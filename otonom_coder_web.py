...
def main() -> None:
    ...
    with col1:
        ...
        st.markdown(
            "_İpucu: max_rounds ≥ 2 ise her görevde önce plan çıkar, sonra dosya aksiyonları üretilir._"
        )
    ...
    if user_input and cfg is not None:
        ...
        with st.chat_message("assistant"):
            ...
            placeholder.markdown("_Görev işleniyor, önce plan sonra dosyalar hazırlanıyor..._")
